...
// End Cross Module References
	...
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_fullHealth);
		P_GET_PROPERTY(FFloatProperty,Z_Param_currentHealth);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=UFloatToPercent::floatToPercent(Z_Param_fullHealth,Z_Param_currentHealth);
		P_NATIVE_END;
	}
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UFloatToPercent_floatToPercent_Statics::NewProp_fullHealth = { "fullHealth", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FloatToPercent_eventfloatToPercent_Parms, fullHealth), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UFloatToPercent_floatToPercent_Statics::NewProp_currentHealth = { "currentHealth", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FloatToPercent_eventfloatToPercent_Parms, currentHealth), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFloatToPercent_floatToPercent_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFloatToPercent_floatToPercent_Statics::NewProp_fullHealth,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFloatToPercent_floatToPercent_Statics::NewProp_currentHealth,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFloatToPercent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFloatToPercent_floatToPercent, "floatToPercent" }, // 1247506530
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UFloatToPercent, 63525746);
